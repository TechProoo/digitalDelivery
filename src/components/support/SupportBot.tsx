...
export default function SupportBot() {
  ...
  // Lock background scroll while open (mobile especially)
  useEffect(() => {
    if (!isOpen) return;
        ...
        {isOpen && (
          <>
            ...
            >
              {/* Header */}
              <div
                className="px-4 py-3 flex items-start justify-between gap-3 shrink-0"
                style={{
              ...
              >
                {authLoading ? (
                  <div className="h-full grid place-items-center">Loading…</div>
                ) : !isAuthenticated ? (
              ...
              {isAuthenticated && (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="submit"
                      className="grid place-items-center rounded-xl h-11 w-11 shrink-0"
                      style={{
                        background: "hsl(var(--primary))",
                        color: "hsl(var(--primary-foreground))",
                        boxShadow: "var(--glow-primary)",
